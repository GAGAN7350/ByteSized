...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('bytesized.openCircuitDesigner', () => {
        const panel = vscode.window.createWebviewPanel('bytesizedCircuitDesigner', 'ByteSized: Microchip & PCB Studio', vscode.ViewColumn.One, {
            enableScripts: true,
...
function getCircuitDesignerHtml() {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
